...
filepath = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\'];
...
filename_output1 = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\smoke_exp_output\smoke_exp_bc_gfed_is4fire_wholeday_smooth_scale_mami.mat'];
save(filename_output1,'smoke_exp');

clearvars smoke_exp
smoke_exp = squeeze(smoke_exp1(:,:,:,:,2));
filename_output1 = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\smoke_exp_output\smoke_exp_oc_gfed_is4fire_wholeday_smooth_scale_mami.mat'];
save(filename_output1,'smoke_exp');

clearvars smoke_exp
smoke_exp = squeeze(smoke_exp2(:,:,:,:,1));
filename_output2 = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\smoke_exp_output\smoke_exp_bc_gfed_noscale.mat'];
save(filename_output2,'smoke_exp');

clearvars smoke_exp
smoke_exp = squeeze(smoke_exp2(:,:,:,:,2));
filename_output2 = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\smoke_exp_output\smoke_exp_oc_gfed_noscale.mat'];
save(filename_output2,'smoke_exp');

clearvars smoke_exp
smoke_exp = squeeze(smoke_exp3(:,:,:,:,1));
filename_output3 = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\smoke_exp_output\smoke_exp_bc_gfed_is4fire_wholeday_smooth_scale_fixnon_injh_mami.mat'];
save(filename_output3,'smoke_exp');

clearvars smoke_exp
smoke_exp = squeeze(smoke_exp3(:,:,:,:,2));
filename_output3 = ['F:\stilt_output\GDAS05\footprints_',num2str(years),'_gfs_nohnf_receptor_se\smoke_exp_output\smoke_exp_oc_gfed_is4fire_wholeday_smooth_scale_fixnon_injh_mami.mat'];
save(filename_output3,'smoke_exp');
end
